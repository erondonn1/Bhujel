...
princp=[]
try:
    prox= requests.get('https://github.com/erondonn1/Eronxbhujel1-.git').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/erondonn1/Eronxbhujel1-.git').text
        ua=open('bbnew.txt','w')
...
\033[1;37m------------------------------------------------
\033[1;32m[\033[1;32m✓] \033[1;36mAUTHOR      :\033[1;32m ERON BHUJEL
\033[1;32m[\033[1;32m✓] \033[1;36mTYPE        :\033[1;33m FREE
\033[1;32m[\033[1;32m✓] \033[1;36mREGION      :\033[1;34m KHOTANG, NEPAL
...
os.system('espeak -a 300 " Welcome,   to,  ERON,  BHUJEL,  Tools"')
pass
...
while attemps < 12345677901:
    ...
    if username == 'ERON' and password == '1':
